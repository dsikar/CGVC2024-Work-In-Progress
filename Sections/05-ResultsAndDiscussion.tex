...
% I am kind of concerned about using the minimal distance in equation 3 and 5 as a metric since it’s not statistically robust. Maybe a more statistically robust measure, like percentile, would be better?
...
Looking at the pattern of the softmax output (network prediction) %gives a good indication of 
...
Conversely, the pattern of the distance to class centroids for a given softmax output %is a good indication of 
